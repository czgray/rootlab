...
from .viz import _VIZ, _apply_fig_defaults, _collect_segment_drawables, _auto_limits
    
def visualize_global_taproot(
    json_file: str | Path,
    ...
    *,
    ...
    for sid in sids:
        ...
        fig_kwargs = _apply_fig_defaults(None, None)
        ...
        if save_dir:
            ...
            plt.savefig(out, dpi=fig_kwargs["dpi"], bbox_inches="tight")
            plt.close(fig)
        else:
            plt.show()
...
def compare_taproot_versions(
    ...
    *,
    ...
    from .viz import visualize_taproot_candidates
